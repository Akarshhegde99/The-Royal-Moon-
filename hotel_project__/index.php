...
if (isset($_POST['user_login_submit'])) {
    ...
    // Redirection logic
    // i dont understand why you put these conditional redirections
    // if (isset($_SESSION['usermail']) && $_SESSION['login_success']) {
    //     header("Location: http://localhost/hotel_project__/reservation.php");
    //     exit();
    // } else {
    ...
    // header("Location: http://localhost/hotel_project__/index.php");
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    <!-- the username field is useless here so i suggest you remove for ease of use -->
